...
#pragma config(Motor,  port3,           LiftE,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           LiftF,         tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port10,          DriveRightB,   tmotorVex393_HBridge, openLoop, driveRight)
