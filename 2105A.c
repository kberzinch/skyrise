...
#pragma config(Motor,  port4,           DriveFrontLeft, tmotorVex393_MC29, openLoop, driveLeft, encoderPort, dgtl3)
#pragma config(Motor,  port5,           DriveFrontRight, tmotorVex393_MC29, openLoop, driveRight, encoderPort, dgtl3)
#pragma config(Motor,  port6,           DriveRearLeft, tmotorVex393_MC29, openLoop, driveLeft, encoderPort, dgtl3)
#pragma config(Motor,  port7,           DriveRearRight, tmotorVex393_MC29, openLoop, driveRight, encoderPort, dgtl3)
