...
#pragma config(Sensor, in8,    LiftLimitMax,   sensorAnalog)
...
#pragma config(Motor,  port3,           LiftLeftB,     tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port6,           DriveRearLeft, tmotorVex393_MC29, openLoop, reversed)
