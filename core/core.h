...
/*
void PID_Cycle(tPID &this) {
this.Error = (this.Target) - (SensorValue[this.Sensor]);
this.Integral = this.Integral + this.Error;
if (this.Error == 0 || abs(this.Error) > this.Margin) {
this.Integral = 0;
}
this.Derivative = this.Error - this.Error_Prev;
this.Error_Prev = this.Error;
Auton_SetMotor(this.Motor,this.Kp * this.Error + this.Ki * this.Integral + this.Kd * this.Derivative);
}
*/
